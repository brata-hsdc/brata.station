...
To verify API:
1
   $ curl -X POST --header 'Accept: application/json' --data '{"message_version": 0, "message_timestamp": "2014-09-15 14:08:59", "station_id": "12345", "station_typl": "SECURE", "station_url": "192.168.2.6:5000"}' http://localhost:8080/m/rpi/join/secure01
